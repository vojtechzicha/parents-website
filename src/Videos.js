...
const conf = {
  0: 'https://1drv.ms/u/s!Al_GOxp7elhTluRJQN_8dNjVuLeeKw',
  1: 'https://1drv.ms/u/s!Al_GOxp7elhTluRNyGTyE8gz_d4JfQ',
}

export const Videos = ({ name }) => {
  ...
  return (
    <Table>
      <Table.Head>
        <Table.TextCell>Videa</Table.TextCell>
